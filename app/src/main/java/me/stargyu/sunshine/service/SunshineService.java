package me.stargyu.sunshine.service;
...
//            double cityLongitude = cityJson.getDouble(OWM_LONGITUDE);
    ...
    protected void onHandleIntent(Intent intent) {
        String locationQuery = intent.getStringExtra(LOCATION_QUERY_EXTRA); // location
        Log.e(LOG_TAG, "onHandleIntent: " + locationQuery);
...
//            Log.v(LOG_TAG, "forecast: " + forecastJsonStr);
    ...
    static public class AlarmReceiver extends BroadcastReceiver {
        ...
        @Override
        public void onReceive(Context context, Intent intent) { // 흐름을 자연스럽게 전달 받음
